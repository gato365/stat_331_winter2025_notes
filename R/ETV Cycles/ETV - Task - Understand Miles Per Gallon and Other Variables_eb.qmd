...
Data visualizations is the graphical representations of data. It is used to communicate information clearly and efficiently through graphical means.
...
mtcars %>% 
  ...
  labs(title = "Scatter Plot of Miles Per Gallon and Weight in lbs for 6 Cylinder Cars",
       x = "Miles Per Gallon",
       y = "Weight in lbs") +
  theme(plot.title = element_text(hjust = 0.5))git
