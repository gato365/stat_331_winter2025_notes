...
library(ggplot2) ## DATA VISUALIZATIONNNN
...
To bring data from some source to your working environment.
...
A data frame is a table or two dimensional array like structure in which eacho column contains values of one variable and each row contains one se of values from each column.
