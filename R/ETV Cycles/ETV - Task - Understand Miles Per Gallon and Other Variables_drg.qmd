...
-   Data transformation is the process of converting data from one format of structure into another format or structure
...
-   Select function is used to select columns from a data frame
...
-   The mutate() function is used to create a new variable or modify an existing variable in the data frame
...
-   Data visualization is the graphical representation of data. It is used to communicate information clearly and efficiently through graphical means
...
mtcars %>% 
  ...
  labs(title = "scatter plot of MPG and HP", 
       x = "MPG", 
       y = "HP" ) +
  theme(plot.title = element_text(hjust = 0.5))
...
```{r}
 mtcars %>% 
  ...
  geom_smooth(methd = "lm", se = FALSE) +
  labs(title = "Scatter plot of MPG and Weight(lbs)", 
       x = "MPG", 
       y = "Weight (lbs)") +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot: geom_boxplot, aes, labs, geom_point, geom_density, theme, theme_bw, 
