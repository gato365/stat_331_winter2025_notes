...
The filter() function allows for certain criteria to be shown as long as it is met
...
Data visualization is the graphical representation of data. It is used to communicate information clearly and efficiently throuh graphical means
...
p1 +
  theme_bw() +
  theme(plot.title = elements_text(hjust = 0.5))
```
