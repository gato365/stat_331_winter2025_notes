...
nba_goats_df %>%
  ...
  geom_point() + 
  scale_fill_manual(values = c("KB" = "purple","LJ" = "gold","MJ" = "red")) + 
  facet_grid(Season ~ Name) + 
  labs(x = "Minutes Played", y = "Points", title = "Pionts by Minutes Played", subtitle = "According to Season and Player") + 
  theme_bw() + 
