...
This task leverages the `mtcars` data set to introduce key concepts in data transformation and visualization using R. Students will engage in a series of sub tasks that reinforce their understanding of data manipulation, filtering, and visualization. The sub tasks emphasize the **ETV framework** (Extraction, Transformation, Visualization) to simulate real-world data analysis processes. These exercises highlight how to explore relationships between variables while encouraging critical thinking through interpretation of results.
...
```{r}
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
...
>>>>>>>> main:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ijw.qmd
```
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
A table or two-dimensional array in which each column contains values of one variable and each row contains one set of values from each column.
========
...
```{r}
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
View(mtcars) ## opens a new tab in a table view
```

```{r}
str(mtcars)  ## into a string
========
View(mtcars)
```
...
select_mpg_mtcars_df <- mtcars %>% 
  select(mpg)
  # select(mpg,wt): you can have more than one variable
  # select(-mpg): will select everything but that variable
```
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
Only 1 variable is seen; the mpg.
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
To select (or to create a subset of the data frame) based on a particular variable.
========
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
Creates a sub set of the data frame based on criteria met.\
(Reduces the number of observations to those that fit the criteria.)
========
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
Create a new variable or modify an existing variable in the data frame.
========
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ac.qmd
The graphical representation of data. It is used to communicate information clearly and efficiently through graphical means.
========
...
mtcars %>%
  ...
  labs(title = "Scatter Plot of HP by MPG", x = "HP", y = "MPG") +
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5))
========
mtcars %>% 
...
-   geom_xxx (different types of plots)
