...
```{r}
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_acl.qmd
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_acl.qmd
Data visualizations is the graphical representation of data. It is used to communicate information clearly and efficiently through graphical means.
========
...
<<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_acl.qmd
  ...
  labs(title = "Scatterplot of MPG and HP", x = "HP", y = "MPG") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
========
  geom_point(color = "red", size =2) +
