...
```{r}
<<<<<<< HEAD
<<<<<<< HEAD:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables.qmd
library(dplyr)   ## Data Transformation
library(ggplot2) ## Data Visualization
=======
library(dplyr)     ## Data Transformation
library(ggplot2)   ## Data Visualization
>>>>>>> c62eed1 (Added libraries for data transformation and visualization):R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ijw.qmd
=======
...
=======
-    Logical (Boolean Logic)
>>>>>>> cfb4078 (Viewing data and data extraction - ijw)
=======
-   Logical (Boolean Logic)
>>>>>>> refs/remotes/origin/cameron_mcclure-coleman
...
>>>>>>> a1aa993 (Learned about Data transformations with R functions)
=======
The select() fucntion is used to select columns from a data frame
>>>>>>> refs/remotes/origin/cameron_mcclure-coleman
...
<<<<<<< HEAD
>>>>>>> b4df34b (CHange some elements of code for class)
=======
>>>>>>> origin/immanuel_williams:R/ETV Cycles/ETV - Task - Understand Miles Per Gallon and Other Variables_ijw.qmd
>>>>>>> refs/remotes/origin/cameron_mcclure-coleman
```
