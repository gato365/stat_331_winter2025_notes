...
Each variable/attribute is stored in its own column
...
Character (Categorical, Categorical binary—- Character, or "strings")
...
The function selects specific variables/attributes (columns) from a data frame.
...
A graphical representation of data, it's used to communicate info clearly and efficiently through graphical means.
